...
abstract class DialogBox {
    ...
    public static android.app.Dialog getDialogSplit(final Context c, final int totalSteps) {
    ...
    public static android.app.Dialog getDialogStat(final Context c, int since_boot) {
        final android.app.Dialog d = new android.app.Dialog(c);
